...
```bash
PYTHONPATH=.github/scripts python -m nno_dashboard.fetch_ci_data \
  --pr_number 67673 \
...
```bash
PYTHONPATH=.github/scripts python -m nno_dashboard.generate_ci_dashboard \
...
This module uses shared utilities from `.github/scripts/common/`:
